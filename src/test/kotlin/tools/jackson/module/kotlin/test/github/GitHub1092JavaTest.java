...
/*
 * Execute with: mvnw test -Dtest=tools.jackson.module.kotlin.test.github.JsonMapperThreadsafetyJavaTest -f pom.xml
 */
@Execution(ExecutionMode.CONCURRENT)
public class GitHub1092JavaTest {

    private static JsonMapper testJsonMapper;

    @BeforeAll
    static void setup() {
        testJsonMapper = JsonMapper.builder().build();
    }
